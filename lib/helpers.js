...
helpers.createRandomString = function(strLength){
	...
	if(strLength){
		//Possible characters
		var possibleChar = 'zxcvbnmasdfghjkl;poiuytrewq1234567890';

		var str = '';
		for (i = 1; i <= strLength; i++) {
			var randomCharacter = possibleChar.charAt(Math.floor(Math.random()* possibleChar.length));
